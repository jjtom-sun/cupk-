        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="单据号">
              <el-input v-model="form.单据号" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
import { fetchZyxmDetail, updateZyxm } from '@/apis/zyxt'
...
const loadData = async () => {
  ...
  const res: any = await fetchZyxmDetail(id)
  if (res.code === 200) form.value = res.data
}

const handleSubmit = async () => {
  try {
    await updateZyxm(form.value.单据号, form.value)
